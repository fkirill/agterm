...
struct Session: ParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [New.self, Close.self, Select.self, Go.self, Rename.self, Move.self, TypeText.self, Split.self, Scratch.self, Focus.self, Copy.self, Status.self, FlagCommand.self, Search.self, Background.self, Overlay.self]
    )
